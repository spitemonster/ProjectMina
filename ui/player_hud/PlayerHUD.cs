...
public partial class PlayerHUD : Control
{
	...
	private void _Setup(PlayerCharacter player)
	{
		...
		_equipmentComponent = _player.CharacterEquipment;
		...
		_weaponHud = GetNode<WeaponHUD>("%WeaponHUD");
		_equipmentComponent.WeaponEquipped += _ConnectWeaponHud;
	}

	private void _ConnectWeaponHud(WeaponComponent weapon)
	{
		_weaponHud.SetWeapon(weapon);
	}
