...
{
    public QueryTestType TestType = QueryTestType.Both;
    ...
    public virtual async Task<Array<Vector3>> RunTest(AgentComponent agent, Array<Vector3> items)
    {
        return await Task.Run(() =>
        {
            ...
            foreach (var item in items)
            {
                ...
                if (TestType is QueryTestType.Filter or QueryTestType.Both)
                {
            ...
            if (TestType is QueryTestType.Score or QueryTestType.Both)
            {
